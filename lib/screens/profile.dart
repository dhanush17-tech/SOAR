                              ...
                              child: auth.currentUser.uid !=
                                  ...
                                  : Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        style: TextStyle(
                                          color:
                                              Color(0xFF3D4254).withOpacity(1),
                                          fontWeight: FontWeight.w400,
                                          fontSize: 15,
                                        ),
                                        onChanged: (val) async {
                            ...
                            auth.currentUser.uid != widget.uidforprofile
                                ...
                                : Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      style: TextStyle(
                                        color: Color(0xFF3D4254).withOpacity(1),
                                        fontSize: 15,
                                      ),
                                      onChanged: (val) async {
                                        print(auth.currentUser.uid);
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            "${course["wow"]}",
                                                                            style:
                                                                                TextStyle(fontWeight: FontWeight.bold, color: Colors.white.withOpacity(1)),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ),
                                                                      ...
                                                                      child: GestureDetector(
                                                                          ...
                                                                          child: Container(
                                                                            ...
                                                                            height:
                                                                                30,
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.white.withOpacity(0.3)),
                                                                            child:
                                                                                Text(
                                                                              "Learn More",
                                                                              style: TextStyle(
