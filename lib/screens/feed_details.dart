          ...
          builder: (context, snap) {
            ...
            return snap.data != null
                ? ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      DocumentSnapshot course = snap.data;
                                ...
                                : Stack(children: [
                                                                ...
                                                                return Row(
                                                                  children: [
                                                                    GestureDetector(
                                                                        onTap:
                                                                            () {
                                                                          auth.currentUser.uid == course["uid"]
                                    ...
                                    tag: "man +iii",
                                                                                child: CircleAvatar(
                                                                                  ...
                                                                                  radius: 40,
                                                                                  backgroundImage: NetworkImage(snap["location"]),
                                                                                ),
                                                                              )
                                                                            : Hero(
                                    tag: "man +iii",
